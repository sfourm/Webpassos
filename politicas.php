...
<html lang="pt-br">
  ...
  <!-- INICIO do conteudo principal. -->
      ...
      <div class="site-section" id="termos">
          <div class="container" >
            <div class= "pr-3 pl-3">
              <div  class= "mr-5 ml-3">
        ...
        <div class="site-section" id="dados">
          <div class="container" >
            <div class= "pr-3 pl-3">
              <div  class= "mr-5 ml-3">
                <div class="justify-content-center text-center" >
                ...
                <p><b>Nome/Razão Social:</b> WebPassos</p>
                <p><b>CPF/CNPJ:</b> 39.784.833/0001-26</p>
                <p><b>Endereço:</b> Rua indiana, 161 - Pq. Residencial Eldorado, Passos - MG</p>
                <p><b>Atividade do site:</b> Desenvolvimento de sites e sistemas web.</p>
                <p><b>E-mail:</b> contato@webpassos.com.br</p>
        ...
        <div class="site-section" id="registro">
          <div class="container" >
            <div class= "pr-3 pl-3">
              <div  class= "mr-5 ml-3" >
                <div class="justify-content-center text-center" >
                ...
                <p>Sendo assim, garantimos que estes terceiros nunca terão acesso aos seus dados pessoais, com as exceções indicadas abaixo, sendo em todo o caso essas comunicações realizadas por parte de WebPassos, como titular da web.</p>
                <br>
                <p><b>ESTE SITE MOSTRA PRODUTOS DE AFILIADO DE TERCEIROS</b></p>
                ...
                <br>
                <p><b>EXATIDÃO E VERACIDADE DOS DADOS</b></p>
                <p>Como usuário, você é o único responsável pela veracidade e alteração dos dados que enviar a WebPassos, exonerando-me de qualquer responsabilidade a respeito.</p>
        ...
        <div class="site-section" id="cancelamento">
          <div class="container" >
            <div class= "pr-3 pl-3">
              <div  class= "mr-5 ml-3" >
                <div class="justify-content-center text-center" >
                  <h4>CANCELAMENTO DE INSCRIÇÃO E O DIREITO DE REVOGAÇÃO</h4>
                  <br>
                </div>
                <p>Como titular dos dados que nos tenha fornecido, pode exercer em qualquer momento os seus direitos de acesso, retificação, cancelamento e oposição, enviando-nos um e-mail para contato@webpassos.com.br anexando uma fotocópia do seu documento de identidade como prova válida.</p>
                <p>Para solicitar seus dados também pode fazer diretamente através desse link: https://webpassos.com.br/contato.php</p>
                <p>Igualmente, você poderá cancelar a qualquer momento para deixar de receber a nosso newsletter ou qualquer outra comunicação comercial, diretamente a partir do mesmo endereço de e-mail que você recebeu ou enviando-nos um e-mail para contato@webpassos.com.br</p>
                <br>          
                <p><b>ACESSO A DADOS POR PARTE DE TERCEIROS</b></p>
                ...
                <p>Este site está hospedado em https://www.locaweb.com.br/ com a marca comercial Locaweb, que oferece serviços de hospedagem para que você possa acessar e navegar pelo nosso site. Pode consultar a política de privacidade e outros aspectos legais dessa empresa no seguinte link: https://www.locaweb.com.br/politicas/.</p>
                ...
                <p>As cookies de redes sociais podem ser armazenadas no seu navegador enquanto você navega pelo blog, por exemplo, quando você usa o botão de compartilhar um artigo do WebPassos em alguma rede social.</p>
                <p>As implicações de privacidade serão em função de cada rede social e dependem da configuração de privacidade que tenha nessa rede. Em nenhum caso, nem eu WebPassos como o responsável por este blog, nem os anunciantes, podemos obter informações de identificação pessoal de cookies.</p>
                <p>Para saber mais sobre as cookies de redes sociais visite nossa Política De Cookies.</p>
                <br>
                <p><b>Google Analytics:</b></p>
                <p>O Google Analytics é um serviço de análise web fornecido pela Google, Inc., uma companhia de Delaware cujo escritório principal está em 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos ("Google").</p>
                ...
                <p>O Google Adsense utiliza cookies para exibir anúncios personalizados neste site. Você pode desativar o uso do cookie DART através do anúncio do Google ou acessando diretamente este link https://adssettings.google.com/authenticated.</p>
                ...
                <p>Se quiser saber mais sobre o uso de cookies e sobre as práticas de recolha de informação e os processos de aceitação ou rejeição, consulte a nossa <a href="cookies.php">Política De Cookies.</a></p>
                <br>
                <p><b>E-Mails Comerciais</b></p>
                <p>Eu WebPassos quero lhe confirmar que não realizo práticas de SPAM, quer dizer que não envio e-mails comerciais que não foram devidamente identificados, solicitados e permitidos pelo Usuário.</p>
        ...
        <div class="site-section" id="seguranca">
          <div class="container" >
            <div class= "pr-3 pl-3">
              <div  class= "mr-5 ml-3">
                <div class="justify-content-center text-center" >
                ...
                <p>Como titular do site, <strong>WebPassos</strong> adotou todas as medidas técnicas e organizacionais necessárias para garantir a segurança e integridade dos dados de carácter pessoal que trate, bem como para evitar a sua alteração, perda, e/ou acesso por parte de terceiros não autorizados.</p>
                ...
                <p>De todas as formas, deve estar ciente de que as medidas de segurança dos sistemas informáticos na Internet não são inteiramente confiáveis, por isso no site <a href="https://webpassos.com.br" target="_blank" rel="nofollow noopener">https://webpassos.com.br</a>, também não posso garantir completamente a inexistência de vírus ou outros elementos que possam produzir alterações nos sistemas informáticos (software e hardware) do Utilizador ou em seus documentos eletrônicos e arquivos que contém.</p>
                <p>Em caso de algum problema de fuga de dados me comprometo a avisar imediatamente as autoridades e a você leitor.</p>
                <p>Para mais informações pode consultar a nossa <a href="cookies.php">Política de Cookies.</a></p>
              </div>
            </div>
          </div>
        </div>
